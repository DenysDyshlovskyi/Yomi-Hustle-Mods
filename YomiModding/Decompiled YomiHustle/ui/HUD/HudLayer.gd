...
func _physics_process(_delta):
	if is_instance_valid(game):
		...
		var p1_paused_initiative = game.game_paused and not p1.check_initiative() and not p1.busy_interrupt
		var p2_paused_initiative = game.game_paused and not p2.check_initiative() and not p2.busy_interrupt
